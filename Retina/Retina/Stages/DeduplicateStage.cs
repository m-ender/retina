...
{
    class DeduplicateStage : RegexStage
    {
        string ReplacementString { get; set; }

        public DeduplicateStage(Options options, string pattern, string replacement)
        ...
        protected override StringBuilder Process(string input)
        {
            ...
            bool rtl = Options.RegexOptions.HasFlag(RegexOptions.RightToLeft);
